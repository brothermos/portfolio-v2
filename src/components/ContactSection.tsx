...
const ContactSection = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const cards = cardsRef.current ? Array.from(cardsRef.current.querySelectorAll<HTMLElement>(".contact-card")) : [];
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl">
        <div ref={headingRef} className="mb-12 md:mb-12 flex justify-center text-center">
          <span className="text-6xl md:text-6xl lg:text-8xl font-bold">Get in touch</span>
        </div>

        <div ref={cardsRef} className="grid gap-10 md:gap-8 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.1fr)]">
