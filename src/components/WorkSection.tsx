        ...
        {PROJECTS.map((project, i) => (
          ...
          >
            ...
            >
              ...
              <div
                className={`hidden md:flex flex-col justify-between text-black px-12 lg:px-16 py-12 lg:py-16 overflow-hidden backdrop-blur-xl h-full min-h-full rounded-[32px] md:rounded-[40px] lg:rounded-[56px] ${project.color}`}
              >
                <div className="flex items-start justify-between gap-2">
                  <span className="text-7xl lg:text-9xl font-bold text-black/15 leading-none">{project.number}</span>
                ...
                <div className="flex items-end justify-between gap-4">
                  <div className="flex flex-col gap-3 min-w-0">
                    <p className="text-xl lg:text-2xl font-medium text-black/70">{project.company}</p>
                    <h3 className="text-5xl lg:text-7xl font-bold leading-tight text-black">{project.title}</h3>
                    <p className="text-xl lg:text-2xl font-medium text-black/80">{project.description}</p>
                  </div>
